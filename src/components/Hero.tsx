...
const Hero = () => {
  ...
  return (
    <section id="inicio" className="min-h-screen flex items-center bg-gradient-to-br from-navy-50 to-white pt-20">
          ...
          <div className="space-y-8 animate-slide-in-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                ...
                className="bg-navy-800 hover:bg-navy-900 text-white px-8 py-3 text-lg h-auto group"
              >
              ...
              <Button 
                ...
                variant="outline"
                className="border-navy-300 text-navy-700 hover:bg-navy-50 px-8 py-3 text-lg h-auto"
              >
                Nossos Serviços
              </Button>
            </div>
